...
namespace TestingAspnetCore.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly TestingAspnetCoreDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = TestingAspnetCoreConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(TestingAspnetCoreDbContext context)
        {
            _context = context;
        }
